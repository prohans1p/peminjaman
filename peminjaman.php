...
<html lang="en">
 ...
 <h1 align="right"><button  type="button" class="btn btn-primary"  data-toggle="modal" data-target="#exampleModal">
  Tambah barang
</button></h1>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Tambah Barng</h5>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="" aria-describedby="" name="kode_barang" >
  </div>
  <div class="form-group">
...
<?php echo"<a href='edit.php?id=$data[id]'></a> </button> | <a href='javascript:hapusData(".$data['id'].")'>Hapus</a>"; ?>
